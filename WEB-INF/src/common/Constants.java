...
public final class Constants {
    ...
    /** URL del servidor */
    public static final String CONFIG_SERVER = "client.server";

    /** Usar proxy */
    public static final String CONFIG_USEPROXY = "client.useProxy";

    /** Host del proxy */
    public static final String CONFIG_PROXYHOST = "client.proxyHost";

    /** Puerto del proxy */
    public static final String CONFIG_PROXYPORT = "cliente.proxyPort";

    /** Usar https */
    public static final String CONFIG_USEHTTPS = "client.userHttps";
